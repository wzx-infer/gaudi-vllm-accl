#!/usr/bin/env python3
"""Stable vision benchmark using vLLM offline inference"""
import os
import time
import json
...
prompts = ["<|image_pad|>Describe this.", "<|image_pad|>Main subject?", "<|image_pad|>Analyze colors.", "<|image_pad|>Mood?"] * 25

print("="*80)
print("Vision Benchmark (Devices 4-7)")
print("="*80)
...
path = f"/data/benchmark_results/vision_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
